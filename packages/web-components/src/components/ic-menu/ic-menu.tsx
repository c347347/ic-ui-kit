...
export class Menu {
        ...
        {option.timedOut ? (
          <Fragment>
            ...
            <ic-button
              ...
              onKeyDown={this.isSearchBar && this.handleRetryKeyDown}
              id="retry-button"
            >
              Retry
            </ic-button>
  ...
  render() {
    const { inputLabel, options, menuId, value, fullWidth, hasTimedOut } = this;

    return (
      <Host
        class={{
          "full-width": fullWidth,
          "no-focus": this.inputEl?.tagName === "INPUT" || hasTimedOut,
        }}
      >
        {options.length !== 0 && (
          <ul
