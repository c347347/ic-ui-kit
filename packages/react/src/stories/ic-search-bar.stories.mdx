...
export const ExternalFiltering = () => {
  ...
  return (
    <IcSearchBar loading={loading} timeout={1000} debounce={300} placeholder="Type to search" label="Search for coffee" onIcChange={handleChange} disableFilter options={results} />
  );
};
